...
스파크 스트리밍은 확장 가능하고 Fault-tolerant를 지원하는 스트리밍 시스템이다.

그렇다고 한다.. 

구조적으로 알아보자면 스파크 스트리밍은 다음과 같이 작동한다.

![image](/images/streaming_flow.png)
...
분명히 이해가 안되는 부분이 있더라도

SparkStreaming이 배치 시스템과 RDD 기반으로 이루어 졌다는 것만 기억하자.

이젠 스파크 스트리밍과 친숙해지기 위해
